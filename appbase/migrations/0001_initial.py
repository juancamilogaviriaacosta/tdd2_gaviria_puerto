# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-31 16:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tiposDeServicio', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='appbase.TiposDeServicio')),
        ...
        migrations.AddField(
            ...
            name='trabajador',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='appbase.Trabajador'),
        ),
    ]
